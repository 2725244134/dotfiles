...
# Removed risky force-push alias - use full command if needed
...
# Removed risky batch delete aliases - use manual deletion for safety
# alias gclean="git branch --merged | egrep -v \"(^\\*|main|master|dev|build|next)\" | xargs git branch -d"
# alias gcleanremote="git branch --merged | egrep -v \"(^\\*|main|master|dev|build|next)\" | xargs -n 1 git push origin --delete"
